...
Description:  Allow integrate skills diagrams (based on tutorial from http://tympanus.net/codrops/2011/04/22/animated-skills-diagram/)
Version:      1.0
...
class Skills_Widget extends WP_Widget {
    ...
    public function __construct() {
        $description = __('Allow skills diagrams', 'skills-widget');
        parent::__construct(
